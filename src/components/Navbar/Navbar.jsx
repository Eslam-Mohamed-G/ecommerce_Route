...
function Templates() {
    ...
    return (
        <div className={`navbar w-full backdrop-blur-sm bg-slate-400/30 fixed top-0 transition-all ease-in-out duration-500 z-50 ${isScroll ? 'py-4' : 'py-8'} mx-auto px-4 sm:px-8`}>
